function init()
    ...
    m.radioButtons.selectedIndex = cities.ottawa
end function
...
sub setUpPalette()
    ...
    m.top.findNode("radioLabel4").color = dialogTextColor
end sub
...
sub radioButtonSelected()
    cities = [
        m.global.city.ottawa,
        m.global.city.toronto,
        m.global.city.montreal,
        m.global.city.calgary,
    ]
    m.top.city = cities[m.radioButtons.selectedIndex]
end sub